...
class MainDisplay {
    companion object {
         ...
         */
        fun displayStartStopMarker(activity: Activity, map: MapView,route: Route) {
         ...
         */
        private fun displayMarker(activity: Activity, map: MapView, point: GeoPoint, title: String, desc: String, res: Drawable?) {
